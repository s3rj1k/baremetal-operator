...
var (
	...
	maxHTTPTimeoutSec = cmp.Or(envInt[int64]("BMO_STARLARK_MAX_HTTP_TIMEOUT_SEC"), int64(3600))
	// Ceiling for requeue_after_seconds; guards against garbage returned by scripts.
	maxRequeueSeconds = cmp.Or(envInt[int64]("BMO_STARLARK_MAX_REQUEUE_SECONDS"), int64(24*60*60))
)
